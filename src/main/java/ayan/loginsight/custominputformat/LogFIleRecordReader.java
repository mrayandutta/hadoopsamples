 ...
 */
public class LogFIleRecordReader extends RecordReader<LongWritable,Text> 
{
    ...
    public LogFIleRecordReader(CombineFileSplit split,TaskAttemptContext context,Integer index) 
    throws IOException 
    {
    ...
    throws IOException, InterruptedException 
    {
           ...
           FileSplit fileSplit1  = new FileSplit(fileSplit.getPath(index),fileSplit.getOffset(this.index),
