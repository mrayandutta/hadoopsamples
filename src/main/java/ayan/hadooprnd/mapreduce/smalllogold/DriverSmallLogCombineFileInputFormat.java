...
public class DriverSmallLogCombineFileInputFormat {
  ...
  public static void main(String[] args) throws Exception {
		...
		conf.setJarByClass(DriverSmallLogCombineFileInputFormat.class);
		String[] jobArgs = new GenericOptionsParser(conf, args)
				.getRemainingArgs();
 
		conf.setMapperClass(MapperSmallLogCombineFileInputFormat.class);
		...
		conf.setMapOutputKeyClass(SmallLogKey.class);
