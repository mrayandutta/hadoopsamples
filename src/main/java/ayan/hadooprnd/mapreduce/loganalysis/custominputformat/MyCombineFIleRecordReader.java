package ayan.hadooprnd.mapreduce.loganalysis.custominputformat;
...
public class MyCombineFIleRecordReader extends RecordReader<LongWritable, Text> 
{
	...
	public void initialize(InputSplit inputSplit,TaskAttemptContext taskAttemptContext) throws IOException,InterruptedException 
	{
		...
		FileSplit fileSplit1 = new FileSplit(fileSplit.getPath(index),
				fileSplit.getOffset(this.index), fileSplit.getLength(),
	...
	{
		/*
		 * if (startOffset == end) { return 0.0f; } else { return Math.min(1.0f,
		 * (pos - startOffset) / (float)(end - startOffset)); }
		 */
