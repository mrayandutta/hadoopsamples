...
public class LogRecordValue implements WritableComparable{
	private Text value1,value2;
	
	public LogRecordValue(){
		this.value1 = new Text();
		this.value2 = new Text();
	}
	public LogRecordValue(Text value1,Text value2){
		this.value1 = value1;
		this.value2 = value2;
	}
	...
	public int compareTo(Object o){
		LogRecordValue other = (LogRecordValue)o;
